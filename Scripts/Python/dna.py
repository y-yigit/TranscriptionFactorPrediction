...
.. note:: SeqIO sequence object cannot be used as a string directly,
          DNA sequences need to be converted to a string first
"""
...
class DNA():
    ...
    def one_hot_encoder(dna_sequences) -> list:
        ...
        return [np.eye(5)[[mapping[base.upper()] for base in sequence]] for sequence in dna_sequences]
    ...
    def generate_random_dna(count: int, nucleotide_percentages: dict) -> list:
        ...
        .. note:: String concatenation is slow
        """
